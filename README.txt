...
This framework can integrate with languages including Python by using SWIG.
...
使用此框架可以快速开发出更多的插件和应用软件，此框架已在 Win/Linux/Mac 上测试过。
...
x3py的开源协议为 Apache License V2.0，你可修改和再分发，但需要保留来源信息。
欢迎使用，谢谢。